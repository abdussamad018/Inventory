                ...
                <table class="table table-striped table-bordered" id="example">
                    ...
                    @foreach($manageproduct as $key=>$Manageproduct)
                        <tr>
                            ...
                            <td><a href="{{route('stockadd',$Manageproduct->Id)}}" data-toggle="modal" data-target="#exampleModal"> <button type="button" class="btn btn-primary btn-sm" > <i class="fas fa-edit"></i></button></a></td>
                        </tr>
                    @endforeach
                    </tbody>
