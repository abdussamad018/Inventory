        ...
        <main class="page-content">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <a href="addsupplier" type="button" class="btn btn-danger btn-sm mb-2" data-toggle="modal" data-target="#delete">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{$supplier->Id}}" data-toggle="modal" data-target="#exampleModal"> <button type="button" class="btn btn-primary btn-sm"> <i class="fas fa-edit"></i></button></a>
