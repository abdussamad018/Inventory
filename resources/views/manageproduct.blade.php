        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <table class="table table-striped table-bordered" id="example">
                    ...
                    <tbody>
                    @foreach($manageproduct as $key=>$Manageproduct)
                        <tr>
                            <td>{{$key+1}}</td>
                            <td>{{$Manageproduct->Product_name}}</td>
                            <td>{{$Manageproduct->Quantity}}</td>
                            <td>{{$Manageproduct->Supplier}}</td>
                            <td>{{$Manageproduct->Retails_price}}</td>
                            <td>{{$Manageproduct->Purchase_price}}</td>
                            <td><img class="image-round" style="height: 40px;width: 40px;"
                                     src="{{$Manageproduct->Picture}}" alt=""></td>
                            <td><a class="btn btn-danger btn-sm" href=""><i class="fa fa-trash-alt"></i></a>
                                <a class="btn btn-primary btn-sm" href=""><i class="fa fa-edit"></i></a></td>
                        </tr>
                    @endforeach
                    </tbody>
