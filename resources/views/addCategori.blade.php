            ...
            <form action="addc" method="post">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" style="color:blue;">Add Category</h5>

                    </div>
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-12">
                                <select class="form-select" name="Brand_name" id="">
                ...
                <div class="card-inner">
                    <table class="table table-striped table-bordered" id="example">
                        ...
                        <tbody>
                            ...
                            @foreach($catagory as $key=>$cata)

                            <tr>

                                <td>{{$key+1}}</td>
                                <td>{{$cata->Brand_name}}</td>
                                <td>{{$cata->Category}}</td>
                                <td>
                                     <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#delete">
                                    <i class="far fa-trash-alt"></i></button>
                               <a href="{{$cata->id}}" data-toggle="modal" data-target="#exampleModal"> <button type="button" class="btn btn-primary btn-sm" > <i class="fas fa-edit"></i></button></a>
...
<div class="modal fade" id="delete" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
          <a href="delete/{{$cata->id}}" class="btn btn-danger btn-sm" >Delete</a>
